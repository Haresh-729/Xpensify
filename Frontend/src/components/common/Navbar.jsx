    ...
    >
      <nav className="flex justify-between items-center p-2 lg:px-10">
        ...
        <div className="flex space-x-6">
          <a
            href="#"
            className="text-gray-600 hover:text-avocado flex items-center"
          >
            Projects
          </a>
          <a
          ...
          <button className="px-4 py-2 bg-avocado text-white rounded-md hover:bg-green-700" onClick={hCi}>
            Register
          </button>
        </div>
      ...
      <div
        ...
        } lg:hidden bg-white shadow-lg absolute w-full z-40`}
      >
        <div className="flex flex-col items-center py-4 space-y-4">
          <Link
            to="/"
            className={`${
              location.pathname === "/" ? "text-yellow" : "text-black"
            } font-bold hover:text-yellow`}
          >
            Home
          </Link>
          <Link
            to="/about"
            className={`${
              location.pathname === "/about" ? "text-yellow" : "text-black"
            } font-bold hover:text-yellow`}
          >
            About
          </Link>
          <Link
            to="/services"
            className={`${
              location.pathname === "/services" ? "text-yellow" : "text-black"
            } font-bold hover:text-yellow`}
          >
            Services
          </Link>
          <Link
            to="/contact"
            className={`${
              location.pathname === "/contact" ? "text-yellow" : "text-black"
            } font-bold hover:text-yellow`}
          >
            Contact
          </Link>
